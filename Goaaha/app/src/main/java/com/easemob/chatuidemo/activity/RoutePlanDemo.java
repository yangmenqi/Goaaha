...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    String startNodeStr = "石家庄";
    String endNodeStr = "衡水";
    ...
    public void searchButtonProcess(View v) {
        ...
        if (v.getId() == R.id.mass) {
            ...
            PlanNode enNewNode = PlanNode.withCityNameAndPlaceName("北京", strE);
            mSearch.drivingSearch((new DrivingRoutePlanOption())
                    .from(stNewNode).to(enNewNode));
            nowSearchType = 1;
//            PlanNode stMassNode = PlanNode.withCityNameAndPlaceName("石家庄", "");
//            PlanNode enMassNode = PlanNode.withCityNameAndPlaceName("衡水", "");
//
...
//            String strS = s.getText().toString();
//            String strE = e.getText().toString();
//            PlanNode stNewNode = PlanNode.withCityNameAndPlaceName(strS, strS);
//            PlanNode enNewNode = PlanNode.withCityNameAndPlaceName(strE,strE);
//            mSearch.drivingSearch((new DrivingRoutePlanOption())
//                    .from(stNewNode).to(enNewNode));
//            nowSearchType = 1;
